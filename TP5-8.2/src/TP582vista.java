 ...
 * @author rodrigo
 */
public class TP582vista extends javax.swing.JFrame {
    
    private DefaultTableModel modelo = new DefaultTableModel();
    /**
     * Creates new form TP582vista
     */
    public TP582vista() {
        initComponents();
        armarCabecera();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TP582vista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TP582vista().setVisible(true);
            }
        });
    }
